...
| Task                                         | Skill to read       |
| -------------------------------------------- | ------------------- |
| Understand architecture / "How does X work?" | `dhpk-gitnexus-exploring`         |
| Blast radius / "What breaks if I change X?"  | `dhpk-gitnexus-impact-analysis`   |
| Trace bugs / "Why is X failing?"             | `dhpk-gitnexus-debugging`         |
| Rename / extract / split / refactor          | `dhpk-gitnexus-refactoring`       |
| Tools, resources, schema reference           | `dhpk-gitnexus-guide` (this file) |
| Index, status, clean, wiki CLI commands      | `dhpk-gitnexus-cli`               |
...
- You want to run index / wiki CLI commands → `dhpk-gitnexus-cli`
- You have a concrete task (understand / impact / debug / refactor) → read that specific gitnexus skill
- The repo has no GitNexus index yet → run `npx gitnexus analyze` first (see `dhpk-gitnexus-cli`)
