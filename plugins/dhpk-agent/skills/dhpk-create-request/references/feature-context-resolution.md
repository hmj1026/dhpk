...
Shared algorithm for resolving "current feature" across document lifecycle skills (`/update-docs`, `/dhpk:dhpk-tech-spec`, `/dhpk:dhpk-create-request`).
...
|-----------------|----------------|-------------|
| Requirements doc | Tech spec (if exists) | `> **Tech Spec**: [Link]` |
| Requirements doc | Active request(s) | `> **Requests**: [Title]` |
| Request doc | Requirements (if exists) | `> **Requirements**: [Link]` |
| Request doc | Tech spec (if exists) | `> **Tech Spec**: [Link]` |
| Tech spec | Requirements (if exists) | `> **Requirements**: [Link]` |
| Tech spec | Active request(s) | `> **Requests**: [Title]` |
...
|----------|-------------------|
| `/dhpk:flow-guide` feature branch doc sync | After precommit pass, auto-detect feature for `/update-docs` + `/dhpk:dhpk-create-request --update` |
| `/dhpk:flow-guide` | `analyze.js` uses same resolver for doc-sync and request-stale suggestions |
