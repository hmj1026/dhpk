...
```
Input: /dhpk:dhpk-create-request Feature: Auth Title: Fix validation Priority: P1
...
```
Input: /dhpk:dhpk-create-request --update docs/features/auth/requests/2026-01-23-fix-login-validation.md
