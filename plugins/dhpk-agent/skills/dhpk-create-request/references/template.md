...
> **Status**: Pending
> **Priority**: {P0|P1|P2}
> **Tech Spec**: [Link] <- Technical detail (primary source)
> **Requirements**: [Link] <- Feature-level problem-space rationale (include this line ONLY IF `../1-requirements.md` exists — omit otherwise to avoid dead links)
...
See [SKILL.md §Phase 4 Auto-Update Items](https://github.com/hmj1026/dhpk/blob/main/skills/dhpk-create-request/SKILL.md) for transition rules. `Blocked` is an informal manual state for out-of-band escalation and is not part of the auto-lifecycle.
