...
```
/dhpk:dhpk-onepassword-session [--account <name>]
     │
     ▼
 op signin --raw
     │
...
```bash
bash skills/dhpk-onepassword-session/scripts/op-session-init.sh
# or with specific account
bash skills/dhpk-onepassword-session/scripts/op-session-init.sh --account my-team
```

### List Available Accounts

```bash
bash skills/dhpk-onepassword-session/scripts/op-session-init.sh --list
```

### Check Session Status

```bash
bash skills/dhpk-onepassword-session/scripts/op-session-init.sh --check
```

### Clear Session

```bash
bash skills/dhpk-onepassword-session/scripts/op-session-init.sh --clear
```
...
```bash
bash skills/dhpk-onepassword-session/scripts/op-with-session.sh read "op://vault/item/field"
bash skills/dhpk-onepassword-session/scripts/op-with-session.sh item list --vault Production
bash skills/dhpk-onepassword-session/scripts/op-with-session.sh whoami
```
...
| `/dhpk:dhpk-onepassword-session --clear` | Removes session file | Removes session file |
...
- [ ] `bash skills/dhpk-onepassword-session/scripts/op-session-init.sh --check` reports an active session
- [ ] A read works: `bash skills/dhpk-onepassword-session/scripts/op-with-session.sh whoami`
