...
1. Apply the immutable Review Request and exact Review Gate obligation supplied
   ...
   `.cursor/dhpk/policies/execution-policy.md`; missing scope or identity
