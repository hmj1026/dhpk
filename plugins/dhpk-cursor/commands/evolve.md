...
contract](https://github.com/hmj1026/dhpk/blob/main/docs/agent-guidance/command-contract.md). Stop on invalid scope or
...
```bash
python3 "${CLAUDE_PLUGIN_ROOT}/skills/dhpk-continuous-learning-v2/scripts/instinct-cli.py" evolve [--generate]
```

Or if `CLAUDE_PLUGIN_ROOT` is not set (manual installation):

```bash
python3 ~/.claude/skills/dhpk-continuous-learning-v2/scripts/instinct-cli.py evolve [--generate]
```
