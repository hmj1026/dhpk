...
```
Design phase    -> /dhpk:dhpk-codex-architect    Get dual-perspective advice
    |
Planning phase  -> /dhpk:dhpk-tech-spec          Produce tech spec document
    |
Review phase    -> /review-spec        Review tech spec
    |
Implementation  -> /dhpk:dhpk-codex-implement    Codex writes code
    |
