...
flowchart LR
    ...
    C -->|Yes| D[Ask Codex]
    D --> C
    C -->|Converge| E[/dhpk:dhpk-codex-architect]
...
/dhpk:dhpk-codex-architect "Evaluate Option A architecture" --mode review

# 5. Decision comparison: compare options
/dhpk:dhpk-codex-architect "Option A vs Option B vs Option C" --mode compare
