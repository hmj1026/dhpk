...
shape is canonicalized in the [reviewer contract](https://github.com/hmj1026/dhpk/blob/main/skills/flow-guide/references/execution-bundle/docs/contracts/reviewer-contract.md).
