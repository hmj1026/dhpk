...
Resolve the active harness directory with `dhpk-harness-revise` before inventory or layer selection.
...
| Fix one controller action / bug | ❌ | `flow-guide` (Bug branch) |
