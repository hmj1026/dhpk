---
name: dhpk-implement
argument-hint: '[--spec <path>] [--target <path>] [--context <files>] [--backend cli|agy] [--second-opinion=codex-exec] <change description>'
...
allowed-tools: 'Bash(git:*), Read, Grep, Glob, Edit, Write, AskUserQuestion, Skill, Agent'
