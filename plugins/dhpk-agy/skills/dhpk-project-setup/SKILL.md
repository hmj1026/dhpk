...
- [host-boundary.md](https://github.com/hmj1026/dhpk/blob/main/skills/dhpk-project-setup/references/host-boundary.md) — read before any Host write or asset install: capability checks and source-artifact rules
- [templates/CLAUDE.md](https://github.com/hmj1026/dhpk/blob/main/skills/dhpk-project-setup/templates/CLAUDE.md), [templates/claude-settings-hooks.json](https://github.com/hmj1026/dhpk/blob/main/skills/dhpk-project-setup/templates/claude-settings-hooks.json), [scripts/install-project-assets.sh](https://github.com/hmj1026/dhpk/blob/main/skills/dhpk-project-setup/scripts/install-project-assets.sh) — first-install template with placeholders and ecosystem blocks, hook merge fragment for installed `.claude/dhpk` assets, and the explicit-artifact asset adapter
