...
argument-hint: '[<scope>] [--format=<format>] [--root=<path>]'
metadata:
...
[`references/workflow.md`](https://github.com/hmj1026/dhpk/blob/main/skills/harness-audit/references/workflow.md) for format handling.
...
- [`references/workflow.md`](https://github.com/hmj1026/dhpk/blob/main/skills/harness-audit/references/workflow.md) — invocation, rubric,
