...
shape is canonicalized in the [reviewer contract](https://github.com/hmj1026/dhpk/blob/main/skills/dhpk-opsx-apply-goal/references/execution-bundle/docs/contracts/reviewer-contract.md).
