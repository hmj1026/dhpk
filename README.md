...
| Canonical skills | 98 flat `dhpk-*` packages | One public name per capability, rooted at `skills/dhpk-*/`; module and Codex project surfaces are projections, not additional sources. |
