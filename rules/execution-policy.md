...
| Plan critique / blind-sketch / dual-plan before implementation, or a warm diff review at task end | `dhpk:planner` — opt-in via `/dhpk:do --plan` on the two implementation-class routes (`dhpk:adaptive-dev-workflow`, `dhpk:opsx-apply-goal`) |
