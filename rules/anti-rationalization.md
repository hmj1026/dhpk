...
Self-talk stop-loss reference for the rationalization phrasings that precede skipping a mandatory reviewer or TDD step. Not always-on; referenced from `${CLAUDE_PLUGIN_ROOT}/rules/execution-policy.md` "Anti-rationalization" section.
