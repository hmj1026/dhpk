...
Generic PHP OWASP examples (injection, XSS, CSRF, file upload, deserialization) live at the installed Codex PHP security guidance. Yii 1.1-specific CSRF, ownership, and encoding live in `security-reviewer/yii.md`.
