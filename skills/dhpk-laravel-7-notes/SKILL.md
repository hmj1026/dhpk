...
- `skills/dhpk-laravel-package-author/SKILL.md` — testbench setup that
  covers 7.x cells in a package matrix
- `skills/dhpk-laravel-6-notes/SKILL.md` — the previous
  version's baseline
- `skills/dhpk-laravel-8-notes/SKILL.md` — the next
