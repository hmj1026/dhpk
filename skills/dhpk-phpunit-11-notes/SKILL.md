...
- PHP 8.0 / 8.1 projects — PHPUnit 11 requires 8.2; use `dhpk-phpunit-10-notes`.
...
- `skills/dhpk-phpunit-10-notes/SKILL.md` — the
  attribute table that this version makes mandatory
- `skills/dhpk-phpunit-9-modern/SKILL.md` — assertion API
  - mock idioms that carry forward unchanged
- `skills/dhpk-php-8x-features/SKILL.md` — `readonly`
