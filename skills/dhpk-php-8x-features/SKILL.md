...
- Legacy PHP 5.6 compatibility work; use `dhpk-php-runtime-router`.
...
- `references/feature-catalog.md` — feature examples, caveats, and mixed-floor
  decision tables.
- `skills/dhpk-php-modern-pro/SKILL.md` — 7.4 baseline and
  dual-version-floor patterns.
- `modules/php-7.4/references/static-checks.md` — lint and analysis pipeline.
- `skills/dhpk-composer-package-hygiene/SKILL.md` — package-floor and release flow.
