...
backfill 範例：`docs/refactor-zpos-js/squash-8b31db0d-unrelated-reviews.md`。
...
- `openspec/changes/verify-zpos-modular-refactor-followup/specs/squash-merge-hygiene/spec.md` — capability spec
- `docs/refactor-zpos-js/squash-8b31db0d-unrelated-reviews.md` — backfill 範例
