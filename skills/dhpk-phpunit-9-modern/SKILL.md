...
- A PHPUnit 5/6/7 project that cannot be upgraded; use the `phpunit-5.7`
  module.
- PHPUnit 10 or 11 projects; use `dhpk-phpunit-10-notes` or `dhpk-phpunit-11-notes`.
...
- `skills/dhpk-legacy-characterization-tests/SKILL.md` — older
  PHPUnit conventions when the project cannot bump.
- `skills/dhpk-laravel-package-author/SKILL.md` — multi-major Laravel package test
