...
Laravel 11's streamlined structure is the supported 11.x layout. If a future
major changes these conventions, resolve that major explicitly before applying
new guidance.

## When NOT to Use

Not for application business logic, and not for a project on a different
Laravel major — return to `SKILL.md` and select the matching family reference. Package-authoring
...
- `references/10.md` — prior version
