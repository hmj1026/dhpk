...
`dhpk-react-19-notes`. Not for generic JS/TS tooling concerns (ESLint config,
...
- `skills/dhpk-react-19-notes/SKILL.md` — the upgrade target
  (Actions, `use()`, ref-as-prop, document metadata, removed legacy APIs)
- `skills/dhpk-nextjs-15-5-notes/SKILL.md` and
  `skills/dhpk-nextjs-16-notes/SKILL.md` — pair a Next.js
