...
description: 'Laravel 11 routing and migration guidance for ^11 projects, bootstrap/app.php, middleware, casts, rate limiting, and 10→11 upgrades. Not for ordinary business logic. Output: version-specific traps and verification gates.'
metadata:
...
- `skills/dhpk-laravel-package-author/SKILL.md` — testbench for 11.x cells
  (Testbench 9.x maps to Laravel 11)
- `skills/dhpk-php-8x-features/SKILL.md` — readonly classes
  / DNF types that L11's 8.2 floor permits
- `skills/dhpk-laravel-10-notes/SKILL.md` — prior version
