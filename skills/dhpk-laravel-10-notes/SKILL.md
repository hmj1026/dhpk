...
- `skills/dhpk-laravel-package-author/SKILL.md` — package author concerns
- `skills/dhpk-php-8x-features/SKILL.md` — readonly / enums
  / intersection types that pair well with L10's type-everywhere stance
- `skills/dhpk-laravel-11-notes/SKILL.md` — next version
