...
- Project: `${XDG_DATA_HOME:-~/.local/share}/dhpk-homunculus/projects/<project-hash>/observations.jsonl`
- Global fallback: `${XDG_DATA_HOME:-~/.local/share}/dhpk-homunculus/observations.jsonl`
...
- Project: `${XDG_DATA_HOME:-~/.local/share}/dhpk-homunculus/projects/<project-hash>/instincts/personal/`
- Global: `${XDG_DATA_HOME:-~/.local/share}/dhpk-homunculus/instincts/personal/` (for universal patterns)
