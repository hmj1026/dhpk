...
Self-contained mental model for `dhpk-skill-quality-judge`. Load this when you need the "why" behind the rubric — what a Skill fundamentally is, the knowledge-delta lens for the First Pass scan, and the meta-question to return to when a score feels off.
