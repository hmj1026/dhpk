# Skill Judge — Full Scoring Rubric (120 points)

Self-contained scoring reference for `dhpk-skill-quality-judge`. Load this when scoring a skill across the 8 dimensions, assigning points, or computing the grade. Each dimension lists score bands, green/red flags, examples, and the evaluation test to apply.

Total = D1 + D2 + D3 + D4 + D5 + D6 + D7 + D8 = **120 points max**.
