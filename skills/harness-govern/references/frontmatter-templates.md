...
Loaded by `harness-govern fill` Phase 4. Required frontmatter fields + required-section lists per product type.
...
Meta-workflow skills (e.g. `harness-govern`, `code-trace`) may use a phase-based structure instead of the 7 sections. Criteria:
