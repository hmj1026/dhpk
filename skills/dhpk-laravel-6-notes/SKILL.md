...
- `skills/dhpk-laravel-package-author/SKILL.md` — service provider /
  facade / publishing patterns that apply across Laravel versions
- `skills/dhpk-laravel-7-notes/SKILL.md` — the next
  version's signature additions (HTTP client, custom casts)
- `skills/dhpk-php-modern-pro/SKILL.md` — PHP idioms valid
