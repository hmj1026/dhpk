...
- Service-provider, facade, publishing, or discovery design outside Testbench setup;
  use `dhpk-laravel-package-author`.
- Semver or dependency-floor decisions; use `dhpk-composer-package-hygiene`.
...
- `skills/dhpk-laravel-package-author/SKILL.md` — provider, facade, publishing, and package
  discovery design outside matrix mechanics.
- `skills/dhpk-composer-package-hygiene/SKILL.md` — dependency and constraint hygiene.
