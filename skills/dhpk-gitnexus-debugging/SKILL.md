...
- You want to understand architecture, not chase a bug → `dhpk-gitnexus-exploring`
- You need the blast radius of a planned change → `dhpk-gitnexus-impact-analysis`
- You need to (re)build the index or run CLI ops → `dhpk-gitnexus-cli`
