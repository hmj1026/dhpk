...
```bash
bash skills/dhpk-codex-cli-review/scripts/review.sh [options]
```
...
/dhpk:dhpk-codex-cli-review

# Compare with main branch
/dhpk:dhpk-codex-cli-review --base main

# With title
/dhpk:dhpk-codex-cli-review --title "Feature: User Auth"

# Custom review instructions
/dhpk:dhpk-codex-cli-review --prompt "Focus on security and performance"
```
