...
- Hand-authoring a specific skill, command, or agent — use `dhpk-create-skill` / `command-creator`.
...
- **Usage**: `. skills/dhpk-continuous-learning-v2/scripts/detect-project.sh`
...
- **Usage**: `pytest skills/dhpk-continuous-learning-v2/scripts/test_parse_instinct.py` (or `python3 -m pytest ...`).
...
- **Usage**: `bash skills/dhpk-continuous-learning-v2/scripts/migrate-homunculus.sh`
...
- Unit tests pass: `pytest skills/dhpk-continuous-learning-v2/scripts/test_parse_instinct.py`.
