...
Resolve the active harness directory with `@skills/dhpk-harness-revise/references/harness-directory-contract.md`; health checks must not silently fall back.
