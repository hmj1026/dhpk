...
This project is indexed by GitNexus as **dhpk** (37742 symbols, 50935 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
