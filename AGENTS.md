...
- Triage labels: use `needs-triage`, `needs-info`, `ready-for-agent`, `ready-for-human`, and `wontfix`; see [triage-labels.md](docs/agents/triage-labels.md). Domain context: read the root `CONTEXT.md` or `CONTEXT-MAP.md`, plus relevant ADRs; see [domain.md](docs/agents/domain.md).
