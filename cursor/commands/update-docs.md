...
Proactive orchestration: the `doc-updater` agent runs this command after structural code changes — see the back-stop in `.cursor/dhpk/policies/execution-policy.md`.
