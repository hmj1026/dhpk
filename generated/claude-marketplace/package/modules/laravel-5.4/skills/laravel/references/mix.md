...
> Source boundary: Guidance below summarizes locked framework docs; it is not application-policy SSOT.
> Mix is an optional legacy asset-pipeline selector, not default Laravel framework coupling.
