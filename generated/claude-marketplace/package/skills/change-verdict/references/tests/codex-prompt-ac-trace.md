...
<!-- Research block source of truth: ../shared/codex-research-instructions.md (Variant: Test Review) -->

## Verification Prompt

**Initial verification**: Use a fresh primary review context; never reuse a
code-review session context.
**Re-verification after gap closure**: Use the AC trace review snapshot and
...
| Initial verification uses a fresh primary context; re-verification uses the review snapshot and a fresh context | ✅ |
