...
function detectTargetMode(rootDir) {
  ...
  if (
    fileExists(rootDir, 'skills/harness-audit/scripts/harness-audit.js') &&
...
function showHelp(exitCode = 0) {
  console.log(`
Usage: node "$SKILL_DIR/scripts/harness-audit.js" [scope] [--scope <repo|hooks|skills|commands|agents>] [--format <text|json>]
       [--root <path>]
