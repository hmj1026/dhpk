...
`code-trace` drives gitnexus_impact + log review + hypothesis testing BEFORE writing any code. Ask about OpenSpec (✅ per the SSOT table) — y: `/opsx:new`; n: brief plan → tdd-guide → patch.
