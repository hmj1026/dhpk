#!/usr/bin/env bash
# pre-route.sh — skill-local deterministic matcher for flow-guide.
#
# Match a free-text request against references/route-table.json (typed
...
#   NO_MATCH                     nothing matched (caller should classify deliberately)
