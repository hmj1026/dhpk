...
|-----|------|---------|--------------|---------|
| `skill_hint_enabled` | boolean | `true` | `DHPK_DISABLE_SKILL_HINT=1` | UserPromptSubmit hook prints a one-line route-table skill suggestion (e.g. "bug" → `/dhpk:dhpk-bug-fix`). |
