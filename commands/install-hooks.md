...
`$harness-setup --install hooks $ARGUMENTS`

Not for: ordinary harness audits, application changes, or silent credential/configuration changes; new callers use `$harness-setup --install hooks` directly.
