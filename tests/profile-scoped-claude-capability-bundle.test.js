...
const EXPECTED_NORMALIZED_MANIFEST_BYTES = 33053;
const EXPECTED_NORMALIZED_MANIFEST_SHA256 = '185cd8f5980b625b090ff12b8508303ea82810bec118812b6f4b45c89f4a9a0b';
...
test('characterizes the current unscoped Claude manifest and CLI outcome', () => {
  ...
  assert.strictEqual(
    ...
    'dhpk Claude publication surface (generated from distribution inventory):\n'
      + '  roots:              1\n'
      + '  generated skill ids: 63 (excludes deprecated; host cannot hide within a shared root)\n',
  );
  ...
  assert.strictEqual(compiled.generated.generatedSkillIds.length, 63);
